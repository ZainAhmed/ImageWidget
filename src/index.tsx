...
import { ImageWidgetProps, ImageWidget } from "./image-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <image-widget message="world!"></image-widget>
   */
  return class ImageWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): ImageWidgetProps {
      const attrs = this.parseAttributes<ImageWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<ImageWidget {...this.props} />, container);
    }
